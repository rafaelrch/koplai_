...
export default function Cadastro() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    setTouched({ nome: true, sobrenome: true, email: true, telefone: true, senha: true });
      ...
      <div className="w-full max-w-[400px] bg-white rounded-2xl shadow-lg p-10 flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            type="text"
            placeholder="Nome"
            className={`w-full bg-[#f8fafc] border ${touched.nome && errors.nome ? 'border-red-400' : 'border-[#e2e8f0]'} rounded-lg px-4 py-3 text-[14px] placeholder-[#94a3b8] focus:border-[#3b82f6] focus:ring-2 focus:ring-[#3b82f6]/20 outline-none transition`}
            value={form.nome}
          ...
          <input
            ...
            className={`w-full bg-[#f8fafc] border ${touched.sobrenome && errors.sobrenome ? 'border-red-400' : 'border-[#e2e8f0]'} rounded-lg px-4 py-3 text-[14px] placeholder-[#94a3b8] focus:border-[#3b82f6] focus:ring-2 focus:ring-[#3b82f6]/20 outline-none transition`}
          ...
          <input
            ...
            type="email"
            placeholder="Email"
            className={`w-full bg-[#f8fafc] border ${touched.email && errors.email ? 'border-red-400' : 'border-[#e2e8f0]'} rounded-lg px-4 py-3 text-[14px] placeholder-[#94a3b8] focus:border-[#3b82f6] focus:ring-2 focus:ring-[#3b82f6]/20 outline-none transition`}
            value={form.email}
            onChange={handleChange}
            onBlur={handleBlur}
            required
          ...
          <input
            ...
            className={`w-full bg-[#f8fafc] border ${touched.telefone && errors.telefone ? 'border-red-400' : 'border-[#e2e8f0]'} rounded-lg px-4 py-3 text-[14px] placeholder-[#94a3b8] focus:border-[#3b82f6] focus:ring-2 focus:ring-[#3b82f6]/20 outline-none transition`}
            value={form.telefone}
            onChange={handleChange}
            onBlur={handleBlur}
            required
          ...
          <input
            ...
            type="password"
            placeholder="Senha"
            className={`w-full bg-[#f8fafc] border ${touched.senha && errors.senha ? 'border-red-400' : 'border-[#e2e8f0]'} rounded-lg px-4 py-3 text-[14px] placeholder-[#94a3b8] focus:border-[#3b82f6] focus:ring-2 focus:ring-[#3b82f6]/20 outline-none transition`}
            value={form.senha}
            onChange={handleChange}
            onBlur={handleBlur}
            required
