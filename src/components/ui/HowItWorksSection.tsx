  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        <span className="mb-8 px-3 py-2 rounded-full bg-[#5756f5] text-white text-lg font-regular tracking-tighter flex items-center justify-around gap-2">
        <span className="inline-block w-10 h-10 rounded-full bg-[#7977f7] border border-[#b7b6fa] flex items-center justify-center"><Bolt size={20}/></span>
          Como funciona?
        </span>
